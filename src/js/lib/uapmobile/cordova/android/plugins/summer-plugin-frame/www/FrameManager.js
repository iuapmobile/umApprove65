...
frame.sendHonor = function(json, successCallback, errorCallback) {
    exec(successCallback, errorCallback, "FrameManager", "sendHonor", [json]);
};
...
frame.setNativeData = function(json, successCallback, errorCallback) {
    exec(successCallback, errorCallback, "FrameManager", "setNativeData", [json]);
};

frame.removeStartPage = function(json, successCallback, errorCallback) {
    exec(successCallback, errorCallback, "FrameManager", "removeStartPage", [json]);
};
frame.getPluginVersion = function(json, successCallback, errorCallback) {
    exec(successCallback, errorCallback, "FrameManager", "getPluginVersion", [json]);
};
