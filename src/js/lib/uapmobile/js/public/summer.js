				...
				_script.onload = function (e) {
					...
					document.addEventListener('deviceready', function(){
						...
						summer.winParam(function(ret){
							...
							summer.getOpenWinTime({},function(res){
...
//            }
        ...
        sendHonor : function(json, successFn, errFn){
			return s.callCordova('summer-plugin-frame.XFrame', 'sendHonor', json, successFn, errFn);
        },
        setNativeData : function(json, successFn, errFn){
			return s.callCordova('summer-plugin-frame.XFrame', 'setNativeData', json, successFn, errFn);
        },
        ...
        removeStartPage: function(json, successFn, errFn){
            if(s.canrequire())
                return s.cordova.require('summer-plugin-frame.XFrame').removeStartPage(json, successFn, errFn);
        },
    };
    ...
    s.sendHonor = s.window.sendHonor;
	s.getOpenWinTime = s.window.getOpenWinTime;
	s.setNativeData = s.window.setNativeData;	
