...
//			_chart.initBindEvent();			
		...
		lightAppMultilingual:function(){			
			//首先设置title
		    var $body = $('body');
		    document.title = eval("billFlowCharLang." + paramUser.lang + ".pageTitle");
			...
			//然后设置页面显示的汉字
			for(var i in eval("billFlowCharLang." + paramUser.lang + ".pageContent")){
			    //i即属性名字ok,close
				console.log("key===" + i + ",value==" + eval("billFlowCharLang." + paramUser.lang + ".pageContent." + i));
				$("." + i ).html(eval("billFlowCharLang." + paramUser.lang + ".pageContent." + i));
			}
			//再设置页面中的placeholder中的汉字
			for(var i in eval("billFlowCharLang." + paramUser.lang + ".pagePlaceHoder")){
			    //i即属性名字ok,close
				console.log("placeholder key===" + i + ",value==" + eval("billFlowCharLang." + paramUser.lang + ".pagePlaceHoder." + i));
				$("." + i ).attr("placeholder",eval("billFlowCharLang." + paramUser.lang + ".pagePlaceHoder." + i));
			}
		},
		//微信禁止分享
...
//				    	console.log(JSON.stringify(result));
				    	if(result==""||typeof(result)=="undefined"){
				    		console.log("流程图加载失败");
				    		//dialog.log(eval("billFlowCharLang." + paramUser.lang + ".pageMessage.flowCharfailedLoad"));//"流程图加载失败"
				    		_chart.show_error(eval("billFlowCharLang." + paramUser.lang + ".pageMessage.flowCharfailedLoad"));//"流程图加载失败"
				    		$("#loding").hide();
				    	}else{
				     ...
				     _chart.show_error(eval("billFlowCharLang." + paramUser.lang + ".pageMessage.Error"));//"调用接口失败"
				     //加载样式处理
				     $("#loding").hide();
				    }
				 });
